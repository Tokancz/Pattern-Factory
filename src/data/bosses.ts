...
export const BOSSES: Record<BossId, BossTuning> = {
  square:   { clicksRequired: 80,  timeLimit: 60, icon: `${BASE}img/patterns/bossSquare.svg` },
  triangle: { clicksRequired: 120, timeLimit: 60, icon: `${BASE}img/patterns/bossTriangle.svg` },
  circle:   { clicksRequired: 150, timeLimit: 60, icon: `${BASE}img/patterns/bossCircle.svg` },
